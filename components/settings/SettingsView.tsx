          ...
          <section className="space-y-3">
            ...
            <div className="glass rounded-[var(--r-lg)] divide-y divide-white/[0.06]">
              <div className="px-4 py-3.5 flex items-center justify-between">
                ...
                <span className="text-text-muted text-sm">1.2.0</span>
              </div>
              <a
                href="https://github.com/het4rk/arkora"
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-3.5 flex items-center justify-between active:opacity-60 transition-opacity"
              >
